...
- `geolocation` is an optional field that specifies the geolocation which will be used. Default value is `1` which represents US providers. Besides US providers, lava supports EU providers on geolocation `2`.
